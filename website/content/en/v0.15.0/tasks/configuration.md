...
| AWS_ENABLE_POD_ENI | \-\-aws-enable-pod-eni | If true then instances that support pod ENI will report a vpc.amazonaws.com/pod-eni resource. Refer to Karpenter Pod ENI documentation before enabling: [Pod ENI documentation](../../aws/provisioning/#pod-eni-security-groups-for-pods) (default = false)|
