...
Once Pod ENI support is enabled in the AWS VPC CNI Plugin, you can enable Pod ENI support in Karpenter.  This can be handled via an environmental variable, command line flag, or via Helm.

* Environmental Variable: `AWS_ENABLE_POD_ENI=true`
* Command Line Flag: `--aws-enable-pod-eni=true`
* Helm: `--set aws.enablePodENI=true`
